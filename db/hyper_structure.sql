...
CREATE TABLE _timescaledb_internal._hyper_5_1_chunk (
    CONSTRAINT constraint_1 CHECK (((started_at >= '2021-02-25 00:00:00'::timestamp without time zone) AND (started_at < '2021-03-04 00:00:00'::timestamp without time zone)))
)
...
CREATE TABLE _timescaledb_internal._hyper_5_2_chunk (
    CONSTRAINT constraint_2 CHECK (((started_at >= '2021-03-04 00:00:00'::timestamp without time zone) AND (started_at < '2021-03-11 00:00:00'::timestamp without time zone)))
)
INHERITS (public.events);
