...
class CountriesController < ApplicationController
  def index
    ...
    @top_countries = base
      ...
      .select("country, count(distinct client_id) as visitors_count, count(*) as count, count(distinct session_id) as sessions_count")
      .group("site_id, country").order("2 desc").limit(100)
  end
end
